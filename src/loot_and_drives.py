...
crash_sites.write("Name,X,Y,Z,ID\n")
for obj in json["objects"]:
    ...
    crash_sites.write(f"{name},{concat_coords},{crash_site}\n")
...
loot_points.write("Item ID,Item Type,Amount,X,Y,Z\n")
for obj in json["objects"]:
    if obj["type"] == 0:
        continue
    ...
    loot_points.write(f"{item_id},{item_type},{item_count},{concat_coords}\n")
